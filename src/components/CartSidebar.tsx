              ...
              {!activeUser && !delivery.email ? (
                <div className="py-10 text-center px-6 bg-white rounded-xl border border-black/5 shadow-sm">
                  ...
                  <p className="text-xs text-black/55 mb-6 leading-relaxed">
                    Inicia sesión con tu cuenta de Google o Facebook para calcular el envío y personalizar tus notas.
                  </p>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white border-2 border-black/10 hover:border-black/25 rounded-xl px-4 py-3.5 text-sm font-bold text-black/75 transition-all shadow-sm active:scale-[0.99] mb-3"
                  >
