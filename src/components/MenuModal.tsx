...
export const categories: Category[] = [
  {
    ...
    dishes: [
      {
        name: "Desayuno Ayacuchano Completo",
  ...
  },
  {
    ...
    dishes: [
      {
        name: "ESCABECHE DE GALLINA TRES GENERACIONES",
        description:
    ...
    dishes: [
      {
        name: "SUMAQ",
        description:
          "Una mezcla que equilibra la acidez del tumbo, la dulzura aromática de la granadilla y la suavidad floral de la manzanilla.",
        price: "S/ 22.00",
      },
      {
        name: "NECTAR ANDINO",
        description:
          "Níspero andino fusionado con maracuyá y anís estrella, logrando un balance entre dulzura, acidez y especias.",
        price: "S/ 22.00",
      },
      {
        name: "TUNA SUA",
        description:
          "Tuna, acompañada de piña y leche condensada, en una mezcla fresca con notas dulces y herbales.",
        price: "S/ 22.00",
      },
      {
        name: "CHICHA DE 8 SEMILLAS",
        description:
          "El sabor único de la chicha de 7 semillas, cuidadosamente fermentada, se combina con la cerveza negra para brindar una experiencia más exquisita.",
        price: "S/ 22.00",
      },
      {
        name: "JORA DEL INKA MODERNO",
        description:
          "Bebida tradicional andina de maíz germinado, mezclada con zumo de maracuyá, que aporta un sabor refrescante.",
        price: "S/ 20.00",
      },
      {
        name: "CHICHA DE QUINUA",
        description:
          "Bebida tradicional de la casa y favorita de muchos, elaborada a base de quinua blanca, 14 frutas y especias.",
        price: "S/ 22.00",
      },
      {
        name: "CARAMBOLA TROPICAL",
        description:
          "Fusión de carambola, piña y limón, con un perfil refrescante y ligeramente ácido.",
        price: "S/ 20.00",
      },
      {
        name: "FRUTOS ROJOS",
        description:
          "Refrescante combinación de frutos rojos ayacuchanos y durazno, con un perfil dulce y vibrante.",
        price: "S/ 22.00",
      },
      {
        name: "HIERBAS ANDINAS",
        description:
          "Encuentro de hierbas andinas, pepino, manzana y limón  en una bebida ligera, refrescante y de carácter herbal.",
        price: "S/ 20.00",
      },
      {
        name: "MARACUMANGO",
        description:
          "Deliciosa bebida en la que el maracuyá se combina con el mango, ofreciendo un sabor único e irresistible.",
        price: "S/ 20.00",
      },
      {
        name: "CHICHA MORADA ESPECIAL",
        description:
          "Bebida tradicional peruana hecha a base de maíz morado, rica en antioxidantes, acompañada de piña y manzana picada.",
        price: "S/ 20.00",
      },
    ],
  },
    ...
    dishes: [
      {
        name: "CARROT CAKE",
        description:
          "Tarta hecha con zanahorias, frutos secos y mantequilla artesanal, un postre suave y jugoso, dándole el color oscuro el azúcar de caña, perfecto para endulzar tus días.",
        price: "S/ 20.00",
      },
      {
        name: "CRÊPE SUZETTE",
        description:
          "Delicadas crêpes francesas, bañadas en una sedosa salsa de naranja y mantequilla, con el toque elegante de brandy que despierta los sentidos.",
        price: "S/ 26.00",
      },
      {
        name: "TARTA VASCA",
        description:
          "La clásica tarta vasca, acompañada de una fina selección de frutos de estación que realzan su textura y equilibrio. Un postre elegante que une la tradición europea con el encanto natural de nuestra sierra.",
        price: "S/ 24.00",
      },
      {
        name: "MAZAMORRA DE CALABAZA",
        description:
          "Postre delicioso originario de los Andes del Perú, elaborado a base de calabaza madura, chancaca y secreto de autor.",
        price: "S/ 15.00",
      },
      {
        name: "PANACOTA CON FRUTOS ANDINOS",
        description:
          "Es un postre italiano irresistible, con un interior cremoso y sedoso. Su versión Andina es una mezcla de todo lo bueno.",
        price: "S/ 20.00",
      },
      {
        name: "TORTINO DE CHOCOLATE ANDINO",
        description:
          "Suave y fundente tortino de chocolate, servido sobre una delicada crema inglesa infusionada con hierba luisa. Cada bocado equilibra el dulzor intenso del cacao con sutiles notas aromáticas del Perú profundo.",
        price: "S/ 22.00",
      },
    ],
  },
