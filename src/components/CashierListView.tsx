                ...
                return (
                  <tr key={ord.id} className="hover:bg-emerald-50/30 transition-colors">
                    ...
                    <td className="py-3 px-4 font-bold text-gray-900">
                      ...
                      <span className="block text-[10px] text-gray-500 font-normal">{ord.client_phone}</span>
                    </td>
                    <td className="py-3 px-4">
                      <span className={`px-2.5 py-0.5 rounded-md text-[10px] font-bold flex items-center gap-1 w-max ${
                    ...
                    <td className="py-3 px-4 uppercase font-extrabold text-[10px] text-gray-800">
