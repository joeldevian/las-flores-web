        ...
        <div className="flex-1 flex flex-col items-center gap-4">
          {ZONES.map(z => (
            ...
            >
              ...
              <span className="text-sm font-normal opacity-0 group-hover:opacity-100 transition-opacity text-[#3b0944]">Ver mapa &rarr;</span>
            </button>
          ))}
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 bg-white/60 backdrop-blur-md border border-ink/10 rounded-2xl relative overflow-hidden shadow-inner p-4 flex flex-col items-center justify-center">
            ...
            <svg viewBox="0 0 100 100" className="w-full max-w-[280px] drop-shadow-md">
              ...
              <text x="50" y="97" fontSize="4" textAnchor="middle" fill="#3b0944" opacity="0.5" fontWeight="bold">ENTRADA</text>
              ...
              {TABLES.map(t => (
                ...
                >
                  ...
                  />
                  <text x={t.x} y={t.y + 1.5} fontSize="4" textAnchor="middle" fontWeight="bold" fill="#3b0944">{t.id}</text>
                </g>
              ))}
            </svg>
          </div>
          ...
          <div className="mt-6 flex justify-center gap-6 text-xs font-semibold opacity-80">
            <span className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-white border border-gray-300"></div> Disponible</span>
            <span className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-gray-100 border border-gray-300"></div> Ocupada</span>
            <span className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-[#F4C430] border-2 border-[#3b0944]"></div> Tu mesa</span>
          </div>
