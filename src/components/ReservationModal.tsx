              ...
              <div className="flex flex-col h-full items-center justify-center animate-in fade-in zoom-in-95 duration-500">
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm text-nogal/70 px-4 leading-relaxed">
                    Inicia sesión con Google o Facebook para asociar tu reserva a tu cuenta de forma rápida y segura.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3 w-full max-w-xs">
                  ...
                  <button
                    onClick={handleGoogleLogin}
                    className="w-full flex items-center gap-4 bg-white px-6 py-4 rounded-2xl shadow-md hover:shadow-lg transition-all border border-black/10 hover:-translate-y-0.5 active:scale-[0.99]"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-4 bg-[#1877F2] hover:bg-[#166FE5] px-6 py-4 rounded-2xl shadow-md hover:shadow-lg transition-all hover:-translate-y-0.5 active:scale-[0.99]"
                  >
                    ...
                    <span className="font-serif font-bold text-white">Continuar con Facebook</span>
                  </button>
                </div>
              </div>
            )}
