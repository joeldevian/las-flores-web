# Sección "Familia Las Flores" Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create and integrate the high-impact "Familia Las Flores" component (`src/components/FamiliaLasFloresSection.tsx`) featuring collaborator testimonials, workplace pride, and food recommendations on `/restaurante`, `/unete-al-equipo`, and `/`.

**Architecture:** Create reusable `FamiliaLasFloresSection.tsx` component with custom styling and Lucide icons, then import and render it on public routes.

**Tech Stack:** React, TypeScript, Lucide React Icons, Tailwind CSS.

---

### Task 1: Create `src/components/FamiliaLasFloresSection.tsx`

**Files:**
- Create: `src/components/FamiliaLasFloresSection.tsx`

- [ ] **Step 1: Write `src/components/FamiliaLasFloresSection.tsx`**

```tsx
import { Quote, Heart, Award, Utensils, Star, Sparkles } from "lucide-react";
...
### Task 2: Integrate `FamiliaLasFloresSection` in Routes

**Files:**
- Modify: `src/routes/restaurante.tsx`
- Modify: `src/routes/unete-al-equipo.tsx`
- Modify: `src/routes/index.tsx`

- [ ] **Step 1: Import and render `<FamiliaLasFloresSection />` in `src/routes/restaurante.tsx`**
- [ ] **Step 2: Import and render `<FamiliaLasFloresSection />` in `src/routes/unete-al-equipo.tsx`**
- [ ] **Step 3: Import and render `<FamiliaLasFloresSection />` in `src/routes/index.tsx`**
...
Plan complete and saved to `docs/superpowers/plans/2026-08-07-familia-las-flores.md`.
